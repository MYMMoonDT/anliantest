<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<link rel="stylesheet" href="ui/css/companySelectionRegister.css">
<div class="panel panel-default form-company">
	...
	<div class="panel-body">
		<form role="form">
			...
			<div class="row">
				<div class="col-sm-6 form-group">
					<label>填表人签字</label> <input type="text" class="form-control"></input>
				</div>
				<div class="col-sm-6 form-group">
					<label>填表时间</label> <input type="text" class="form-control"></input>
				</div>
			</div>			
		</form>
	</div>
